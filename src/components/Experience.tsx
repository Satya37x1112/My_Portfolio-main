...
const Experience: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="experience" className="py-20 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 scroll-mt-20 relative overflow-hidden">
