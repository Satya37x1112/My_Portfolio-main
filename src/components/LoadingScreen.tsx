  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setProgress((prev) => {
        ...
        return prev + Math.random() * 20; // Faster progress increment
      });
    }, 80); // Faster interval
      ...
      {loading && (
        ...
        >
          <div className="text-center space-y-8">
            {/* Profile Image - Faster animation */}
            <motion.div
            ...
            >
              ...
              <p className="text-cyan-400 mt-4 text-base tracking-wide font-medium">
